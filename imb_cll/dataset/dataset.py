...
def prepare_cluster_dataset(input_dataset, data_type=None, kmean_cluster= None, max_train_samples=None, multi_label=False, augment=False, imb_type=None, imb_factor=1.0, pretrain=None, transition_bias = 1.0, setup_type=None):
    if input_dataset == "CIFAR10":
        if data_type == "train":
            dataset = CLCIFAR10(
                root="./data/cifar10",
